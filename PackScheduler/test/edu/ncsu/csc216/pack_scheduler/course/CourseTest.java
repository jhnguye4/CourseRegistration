...
public class CourseTest {
	...
	private static final int ENROLL_CAP = 15;
...
//		}
	...
	public void testCompareTo() {
		Course s1 = new Course("CSC216", TITLE, "001", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s2 = new Course("CSC216", TITLE, "001", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s3 = new Course("CSC216", TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s4 = new Course("CSC116", TITLE, "001", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course s5 = new Course("CSC116", TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLL_CAP, MEETING_DAYS, START_TIME, END_TIME);
		
		//Testing object that has same name and section
		assertEquals(0, s1.compareTo(s2));
		assertEquals(0, s2.compareTo(s1));
		//Testing object that has same name but different section
		assertEquals(-1, s1.compareTo(s3));
		assertEquals(1, s3.compareTo(s1));
		//Testing object that has different name but same section
		assertEquals(1, s1.compareTo(s4));
		assertEquals(-1, s4.compareTo(s1));
		//Testing object that has different name and different section 
